...
public class DateUtils {
     ...
     * @return
     */
    public static String numberToDate(Long target, String pattern) {
     ...
     */
    public static String chineseToDate(String date, String pattern) {
        Date newDate = null;
        try {
